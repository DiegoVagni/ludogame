...
public class Player
{
                ...
                foreach (List<Pawn> couple in fusedPawns)
                {
                    ...
                    foreach (Pawn p in couple)
                    {
                        ...
                        if (m2 != null)
                        {
                            ...
                            foreach (Pawn couplePawn in couple)
                            {
                                if (couplePawn.GetPawnNumber() != p.GetPawnNumber())
                                {
                                    m2.GetPawn().Add(couplePawn);
                                }
                            }
    ...
    {
        for (int i = 0; i < m.GetPawn().Count; i++)
        {
            Pawn p = m.GetPawn()[i];
